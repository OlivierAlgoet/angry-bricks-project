...
void Allkit::DrawLine(Point& a, Point& b) {
    al_draw_line(a.x_, a.y_, b.x_, b.y_, al_map_rgb(0, 0, 0), 3);
}
...
void Allkit::PlayLaunchSound() {
    al_play_sample(launch, 1.0, 0.3, 1.0, ALLEGRO_PLAYMODE_ONCE, NULL);
}
*/